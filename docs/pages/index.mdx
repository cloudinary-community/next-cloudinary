...
<div className="text-center max-w-xl mx-auto mt-36 mb-44">
  <h1 className="text-6xl font-bold">Next Cloudinary</h1>
  ...
  <p className="flex items-center justify-center gap-6 mt-8">
    <CldImage
      width="218"
      height="42"
...
<div className="text-center max-w-4xl mx-auto my-44">
  <h2 className="text-4xl font-bold">What's Inside?</h2>

  <ul className="grid grid-cols-2 gap-16 mt-20">
    <li>
      <CldImage
    ...
    <li>
      ...
      <p>Drop-in width for easily <Link className="underline underline-offset-2" href="/guides/uploading-images-and-videos">uploading assets</Link> into the cloud.</p>
    </li>
    <li>
      <CldImage
        className="rounded-lg border border-zinc-200 mb-6"
...
<div className="text-center max-w-2xl mx-auto my-44">
  <h2 className="text-5xl font-bold leading-[4rem]">Transform &amp; Deliver at Scale with Next Cloudinary</h2>
  <p className="mt-10"><Button href="/installation">Get Started</Button></p>
</div>