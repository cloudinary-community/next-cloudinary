...
<Callout emoji={false}>
  Using the Next.js 13 App Router? This component is only supported in the Pages directory. Try the [getCldOgImageUrl](/helpers/getcldogimageurl/basic-usage) helper inside of your metadata configuration.
</Callout>
