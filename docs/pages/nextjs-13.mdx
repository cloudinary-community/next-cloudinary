...
The Head component is not supported in the Next.js App directory, meaning, the [CldOgImage](/cldogimage/basic-usage) component will not function.

Instead, you can easily generate OG image URLs using [getCldOgImageUrl](/getcldogimageurl/basic-usage) in your metadata configuration:
