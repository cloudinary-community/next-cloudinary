...
Or see a full example of an API endpoint used with the Next Cloudinary docs in the Pages Router: https://github.com/cloudinary-community/next-cloudinary/blob/main/docs/pages/api/sign-cloudinary-params.js
