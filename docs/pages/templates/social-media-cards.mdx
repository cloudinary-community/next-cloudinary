...
<HeaderImage>
  <CldImage
    ...
    overlays={[
      ...
      {
        publicId: `${process.env.IMAGES_DIRECTORY}/white`,
        width: 2000,
        height: 4,
        effects: [{
...
<Tabs items={['getCldOgImageUrl (App)', 'CldOgImage (Pages)']}>
  <Tab>
    ...
    <CodeBlock>
      ...
      // The public ID can be any available asset, even a 1x1 pixel. It's used as the underlaying basis
      // to create an image with a gradient dynamically
      const publicId = 'images/white';
