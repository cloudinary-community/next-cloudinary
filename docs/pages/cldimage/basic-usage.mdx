...
As CldImage is a wrapper around the Next.js Image component, you also gain access to all built-in Image component features will work out-of-the-box like [Responsive Sizing](/responsive-images).
...
The `sizes` prop is optional, but recommended for [Responsive Sizing](/responsive-images).
