...
CldImage extends the Next.js Image component, meaning props available on 
...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      type: 'array',
      default: '-',
      example: () => (<a href="#overlay--underlay-props">Overlay & Underlay Props</a>)
    },
    {
...
The `overlays` and `underlays` props are an arrays of objects that position and transform a layer above or below the primary image.

Underlays are similar to overlays except they do not support text.
...
<Table
  ...
  data={[
    ...
    },
    {
      prop: 'effects',
      type: 'array',
      example: () => (<a href="#effect--transformation-props">Effects & Transformations</a>)
    },
    {
      prop: 'position',
      type: 'object',
      example: () => (<a href="#position">Position</a>)
    },
    {
      prop: 'publicId',
      type: 'string',
    ...
    },
    {
      prop: 'text',
      type: 'object|string',
      example: () => (<span><code>Next Cloudinary</code> or See <a href="#text">Text</a> Below</span>)
    },
    {
      prop: 'url',
      type: 'string',
...
Objects in the effects array can include everything in [Effect Props](#effect-props) above as well as:
