...
<Head>
  ...
  <meta name="og:url" content={`https://next-cloudinary.spacejelly.dev/components/getcldimageurl/configuration`} />
</Head>
...
Configuration for getCldImageUrl is the same as [CldImage](/components/cldimage/configuration), which both use the same underlying API [@cloudinary-util/url-loader](https://github.com/colbyfayock/cloudinary-util/tree/main/packages/url-loader).
