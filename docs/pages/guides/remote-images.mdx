...
This will generate a Cloudinary URL `https://res.cloudinary.com/<your-cloud-name>/image/fetch/f_auto,q_auto,w_960,h_600/https://www.wikipedia.org/portal/wikipedia.org/assets/img/Wikipedia-logo-v2@2x.png`,
