...
<Head>
  <title>Image Placeholders - Next Cloudinary</title>
  <meta name="og:title" content="Adding image placeholders in Next Cloudinary" />
  <meta name="og:url" content={`https://next.cloudinary.dev/guides/placeholders`} />
</Head>

<OgImage
  title="Image Placeholders"
  twitterTitle="Image Placeholders"
/>
